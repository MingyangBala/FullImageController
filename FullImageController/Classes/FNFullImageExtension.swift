...
//    typealias T = FNFullImage
    ...
    public required init?(imageArray: Array<FNFullImage>, currentIndex: Int, pageControlType: FIPageControlType) {
...
public class CommentFullImageController : FullImageViewController {
   ...
   public required init?(imageArray: Array<CommentImage>, currentIndex: Int, pageControlType: FIPageControlType) {
    ...
    required public init?(imageArray: Array<FNFullImage>, currentIndex: Int, pageControlType: FIPageControlType) {
        fatalError("init(imageArray:currentIndex:pageControlType:) has not been implemented")
    }
